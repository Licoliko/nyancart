...
costume_sets = [
    ...
    ("aruka-sham", "grid-queen"),
    ("kurone-night", "moonlight-ace"),
    ("kurone-night", "lunar-grid-queen"),
    ("kohaku-taiga", "sunset-rally"),
    ("kohaku-taiga", "tiger-grid-queen"),
    ("ghost-rex", "phantom-gala"),
    ("ghost-rex", "phantom-grid-queen"),
    ("nerine-korat", "aqua-parade"),
    ("nerine-korat", "aqua-grid-queen"),
    ("fumika-scotty", "sunrise-airmail"),
    ("fumika-scotty", "airmail-grid-queen"),
    ("bell-savanna", "sunset-huntress"),
    ("bell-savanna", "savanna-grid-queen"),
